...
namespace Sistema.Presentacion
{
    public partial class FrmCliente : Form
    {
        ...
        private void Listar()
        {
            try
            {
                DgvListado.DataSource = NCliente.ListarClientes();
                this.Formato();
                this.Limpiar();
        ...
        private void Buscar()
        {
            try
            {
                DgvListado.DataSource = NCliente.BuscarClientes(TxtBuscar.Text);
                this.Formato();
                LblTotal.Text = "Total registros: " + Convert.ToString(DgvListado.Rows.Count);
            }
            catch (Exception ex)
        ...
        private void BtnInsertar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    Rpta = NCliente.Insertar("Cliente", TxtNombre.Text.Trim(), CboTipoDocumento.Text, TxtNumDocumento.Text.Trim(), TxtDireccion.Text.Trim(), TxtTelefono.Text.Trim(), TxtEmail.Text.Trim());
                    if (Rpta.Equals("OK"))
                    {
        ...
        private void BtnActualizar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    Rpta = NCliente.Actualizar(Convert.ToInt32(TxtId.Text), "Cliente", this.NombreAnt, TxtNombre.Text.Trim(), CboTipoDocumento.Text, TxtNumDocumento.Text.Trim(), TxtDireccion.Text.Trim(), TxtTelefono.Text.Trim(), TxtEmail.Text.Trim());
                    if (Rpta.Equals("OK"))
                    {
