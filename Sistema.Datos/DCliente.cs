    ...
    public class DCliente
    {
        public DataTable Listar()
        {
            ...
            try
            {
                ...
                SqlCommand Comando = new SqlCommand("Cliente_listar", SqlCon);
        ...
        public DataTable Buscar(string Valor)
        {
            ...
            {
                SqlCon = Conexion.getInstancia().CrearConexion();
                SqlCommand Comando = new SqlCommand("Cliente_buscar", SqlCon);
                Comando.CommandType = CommandType.StoredProcedure;
        ...
        public DataTable BuscarClientes(string Valor)
        {
            ...
            {
                SqlCon = Conexion.getInstancia().CrearConexion();
                SqlCommand Comando = new SqlCommand("Cliente_buscar_clientes", SqlCon);
                Comando.CommandType = CommandType.StoredProcedure;
                Comando.Parameters.Add("@valor", SqlDbType.VarChar).Value = Valor;
                SqlCon.Open();
                Resultado = Comando.ExecuteReader();
        ...
        public string Actualizar(Cliente Obj)
        {
            ...
            try
            {
                ...
                Comando.CommandType = CommandType.StoredProcedure;
                Comando.Parameters.Add("@idpersona", SqlDbType.Int).Value = Obj.IdCliente;
                Comando.Parameters.Add("@nombre", SqlDbType.VarChar).Value = Obj.Nombre;
                Comando.Parameters.Add("@tipo_documento", SqlDbType.VarChar).Value = Obj.TipoDocumento;
                Comando.Parameters.Add("@num_documento", SqlDbType.VarChar).Value = Obj.NumDocumento;
                Comando.Parameters.Add("@direccion", SqlDbType.VarChar).Value = Obj.Direccion;
